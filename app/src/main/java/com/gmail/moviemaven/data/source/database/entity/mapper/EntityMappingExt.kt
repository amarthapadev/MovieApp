package com.gmail.moviemaven.data.source.database.entity.mapper
...
import com.gmail.moviemaven.data.source.network.models.credits.Cast
...
fun com.gmail.moviemaven.data.source.network.models.similar.Result.toEntity() =
    SimilarMovieEntity(
        id = id,
        posterPath = poster_path ?: ""
    )
...
fun List<com.gmail.moviemaven.data.source.network.models.similar.Result>.toEntity() =
    map(com.gmail.moviemaven.data.source.network.models.similar.Result::toEntity)
